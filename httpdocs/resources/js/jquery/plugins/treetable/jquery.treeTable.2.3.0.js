...
(function($) {
  ...
  /* Alterado por Rodrigo Joriz - iMDT - Negócios Iteligentes - www.imdt.com.br
   * rodrigoj@imdt.com.br
   * 
   * add move parameter to control if must move the inserter element to the top of the destination children.
   * if move === false, then do not move.
   * move defaults is true;
   *
   */ 
  $.fn.appendBranchTo = function(destination, move) {
    var node = $(this);
  ...
  $.fn.toggleBranch = function() {
    if($(this).hasClass("collapsed")) {
      ...
      $(this).removeClass("expanded").collapseTreeTable();
    }
