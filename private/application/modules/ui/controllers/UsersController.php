...
class Ui_UsersController extends IMDT_Controller_Abstract {
    ...
    public function advSearchFilterAction() {
        ...
        try {
            ...
            $strOptions = '';
            foreach ($arr as $obj) {
                if(IMDT_Util_Auth::getInstance()->get('user_access_profile') == BBBManager_Config_Defines::$SYSTEM_PRIVILEGED_USER_PROFILE && $obj['access_profile_id'] != BBBManager_Config_Defines::$SYSTEM_USER_PROFILE) continue;
                
                if($obj['access_profile_id'] == BBBManager_Config_Defines::$NA_PROFILE) continue;
